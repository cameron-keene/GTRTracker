...
class UntitledModel extends Model {
  ...
  const UntitledModel._internal({required this.id, createdAt, updatedAt}): _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory UntitledModel({String? id}) {
  ...
  UntitledModel copyWith({String? id}) {
    return UntitledModel._internal(
      id: id ?? this.id);
  }
